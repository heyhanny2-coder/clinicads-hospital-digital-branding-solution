...
const AnnouncementPopup: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div
        className="relative w-full max-w-md bg-white rounded-2xl shadow-xl border border-brand-rose overflow-hidden animate-fade-in"
        role="dialog"
      ...
      >
        ...
        <div className="p-6 space-y-4 text-brand-navy text-[15px] leading-relaxed">
          <p>
            진단서 및 견적서 발송을 위해 <strong className="text-brand-navy">병원명, 성함, 직책</strong> 등의 기본정보 확인이 필요합니다.
          </p>
          <p>
        ...
        <div className="px-6 pb-6">
          <button
            onClick={handleClose}
            className="w-full py-3 bg-brand-navy hover:bg-brand-navy/90 text-white font-semibold rounded-xl transition-colors"
          >
            확인
          </button>
        </div>
